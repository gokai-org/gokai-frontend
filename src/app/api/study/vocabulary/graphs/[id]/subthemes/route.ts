...
export async function POST(
  ...
  const upstreamPath = `/vocabulary/graphs/${id}/subthemes`;
  ...
  try {
    ...
    console.error("POST /api/study/vocabulary/graphs/[id]/subthemes error:", error);
    return NextResponse.json(
      { error: "Error interno al seleccionar subtema" },
      { status: 500 },
    );
  }
}
