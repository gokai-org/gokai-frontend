    ...
    <main className="relative min-h-screen overflow-hidden bg-neutral-50">
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-16">
        ...
        >
          ...
          <p className="mt-6 text-2xl md:text-4xl font-extrabold text-[#993331]">
            Elige tu plan
          </p>
          <h1 className="mt-2 text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-neutral-900">
        ...
        >
          ...
          <Link
            href="/auth/login"
            replace
            className="font-semibold text-[#993331] hover:underline transition"
          >
            Inicia sesión
          </Link>
        </motion.p>
