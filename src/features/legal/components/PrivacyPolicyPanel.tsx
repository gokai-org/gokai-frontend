      ...
      <div className="mt-4 space-y-4 sm:mt-5">
        <LegalSection title="1. Identidad del responsable y contacto">
          <p>
            ...
            dar soporte, facturar y proteger la Plataforma son responsables del
        ...
        <LegalSection title="3. Qué datos solicitamos y en qué momentos">
          <p>
            ...
            tratamos dependen de la acción que realices dentro de la Plataforma
            y de las funciones que decidas usar.
          </p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-content-secondary">
                Cuando creas una cuenta o inicias sesión, GOKAI puede solicitar
                y tratar datos como:
              </p>
              <LegalList
                items={[
                  ...
                  <>
                    Contraseña, código de verificación y datos de autenticación
                    o sesión equivalentes.
                  </>,
                  <>
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-content-secondary">
                Cuando utilizas la Plataforma para estudiar, GOKAI puede tratar
                datos como:
              </p>
              <LegalList
                items={[
                  <>
                    ...
                    precisión, rachas, repasos y otras métricas de aprendizaje.
                  </>,
                  <>
            ...
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-content-secondary">
                Si escribes a soporte, envías comentarios o haces una solicitud,
                GOKAI puede tratar:
              </p>
              <LegalList
                items={[
            ...
            <div>
              <h3 className="text-sm font-semibold text-content-primary">
                3.4. Para retroalimentación de pronunciación y funciones de voz
              </h3>
              <p className="mt-2 text-sm leading-7 text-content-secondary">
              ...
              <LegalList
                items={[
                  <>
                    GOKAI puede solicitar acceso al micrófono de tu dispositivo
                    para capturar audio.
                  </>,
                  <>
          ...
          <LegalList
            items={[
              ...
              <>
                ...
                lecciones, repaso, recomendaciones y retroalimentación según tu
                progreso.
              </>,
              <>
              ...
              <>
                <strong>Soporte:</strong> atender solicitudes, dudas y reportes.
              </>,
              <>
                <strong>Mejora del servicio:</strong> medir desempeño, corregir
                errores y optimizar la experiencia.
              </>,
              <>
        ...
        <LegalSection title="5. Bases para el tratamiento">
          ...
          <LegalList
            items={[
              ...
              <>
                <strong>Consentimiento</strong>, por ejemplo cuando habilitas y
                usas funciones de micrófono o audio.
              </>,
              <>
        ...
        <LegalSection title="6. Funciones de IA y decisiones automatizadas">
          ...
          <div className="mt-4">
            ...
            <p className="mt-2 text-sm leading-7 text-content-secondary">
              ...
              aprendizaje automático. En algunos casos, el audio puede enviarse
        ...
        <LegalSection title="8. Compartición de datos con terceros">
          ...
          <LegalList
            items={[
              <>
                <strong>Proveedores de servicios</strong> que ayudan a operar la
                Plataforma, por ejemplo hosting, almacenamiento, correo,
        ...
        <LegalSection title="13. Privacidad de menores">
          <p>
            La Plataforma no está dirigida a menores de <strong>13 años</strong>.
          </p>
          <p>
          ...
          <p>
            ...
            funcionalidades, rechazar registros o cerrar cuentas cuando detecte
            inconsistencias en la edad declarada o falta de autorización
            suficiente.
          </p>
          <p>
            Si eres madre, padre o tutor y crees que un menor proporcionó datos
            personales sin autorización adecuada, contáctanos para tomar
            medidas razonables.
          </p>
        </LegalSection>
