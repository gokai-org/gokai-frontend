...
export function ChatConversation({
  ...
  return (
    <AnimatedEntrance
      ...
      className="w-full"
    >
      <section className="w-full rounded-[30px] border border-gray-100 bg-[#FCFCFC] shadow-[0_2px_18px_-8px_rgba(0,0,0,0.08)]">
        <div className="border-b border-gray-100 bg-white px-4 py-4 sm:px-6">
          <div className="flex items-center justify-between gap-4">
            ...
            <span className="rounded-full bg-[#993331]/8 px-3 py-1 text-xs font-semibold text-[#993331]">
