...
const KANJI_TABS: AnimatedLessonTab<KanjiTab>[] = [
...
export default function KanjiLesson({
  ...
  const switchTab = useCallback((tab: KanjiTab) => {
    if (tab === activeTab) return;
    setDir(getAnimatedTabDirection(KANJI_TABS, activeTab, tab));
    setActiveTab(tab);
  }, [activeTab]);
