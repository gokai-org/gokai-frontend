    ...
    >
      <div className="border-b border-border-subtle pb-4">
        ...
        <p className="mt-3 max-w-3xl text-xs leading-6 text-content-secondary md:text-sm">
          ...
          <strong>“Términos”</strong>) regulan el acceso y uso de la plataforma{" "}
          <strong>GOKAI</strong> (en adelante, la <strong>“Plataforma”</strong>),
          incluyendo su sitio web, aplicaciones, funcionalidades y servicios
          asociados.
        </p>
        <p className="mt-2 max-w-3xl text-xs leading-6 text-content-secondary md:text-sm">
          Al acceder, registrarte o usar la Plataforma, aceptas quedar obligado
          por estos Términos. Si no estás de acuerdo, no uses la Plataforma.
        </p>
      </div>
      ...
      <div className="mt-4 space-y-4 sm:mt-5">
        ...
        <LegalSection title="2. Definiciones">
          ...
          <LegalList
            items={[
              ...
              <>
                <strong>“Servicios de IA”</strong>: funciones que usan sistemas
                automatizados para generar recomendaciones, conversación,
                análisis o retroalimentación.
              </>,
              <>
                <strong>“IA de pronunciación”</strong>: funcionalidad que
                analiza audio de la voz del Usuario para evaluar pronunciación y
                dar retroalimentación.
              </>,
              <>
                <strong>“Métricas de aprendizaje”</strong>: indicadores de uso y
                progreso, como lecciones completadas, precisión, repasos,
        ...
        <LegalSection title="3. Descripción general del servicio">
          ...
          <LegalList
            items={[
              ...
              <>
                IA de pronunciación para retroalimentación automática basada en
                audio.
              </>,
            ]}
          />
          <p>
            ...
            periodos semanales o mensuales, o con otra periodicidad informada en
            la función correspondiente. Entre otras, las métricas pueden incluir
            progreso por tema, lecciones completadas, repasos realizados,
            precisión en ejercicios, rachas y tiempo de estudio.
          </p>
          <p>
        ...
        <LegalSection title="4. Requisitos de uso y elegibilidad">
          ...
          />
          <p>
            La Plataforma no está dirigida a menores de 13 años.
          </p>
          <p>
            ...
            registro o cerrar cuentas cuando no exista autorización válida para
            menores de edad.
          </p>
        </LegalSection>
        ...
        <LegalSection title="5. Registro de cuenta y seguridad">
          ...
          <p>
            El acceso a funcionalidades puede depender del tipo de cuenta, plan
            activo, verificación de correo, edad declarada, región, dispositivo,
            compatibilidad técnica, disponibilidad beta y cumplimiento de estos
            Términos.
          </p>
          <LegalList
            items={[
              ...
              <>
                ...
                notificar de inmediato cualquier uso no autorizado, vulneración
          ...
          <p>
            ...
            incluido el mal uso de credenciales de acceso. Para evaluar posibles
            incumplimientos y resolver reclamos de seguridad, GOKAI podrá
            revisar registros de acceso, actividad simultánea inusual,
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <LegalList
                items={[
                  <>
                    El proveedor puede requerir información adicional y aplicar
                    sus propios términos y políticas.
                  </>,
                  <>
                    GOKAI no almacena necesariamente la información completa de
                    tu tarjeta, según el flujo del proveedor.
                  </>,
                ]}
              />
            </div>
            ...
            <div>
              ...
              <p>
                GOKAI podrá solicitar la información fiscal necesaria y emitirá
                la factura por medio de la entidad o persona habilitada por
                GOKAI para ese fin al momento de la solicitud.
              </p>
            </div>
          </div>
        </LegalSection>
        ...
        <LegalSection title="7. Uso permitido, cuenta personal y código de conducta">
          ...
          <LegalList
            items={[
              ...
              <>
                Hacer mal uso de credenciales, automatizaciones o integraciones
                no autorizadas.
              </>,
            ]}
          />
          <p>
            ...
            definitiva de la Cuenta, según la gravedad, recurrencia y evidencia
            disponible.
          </p>
        </LegalSection>
        ...
        <LegalSection title="8. Propiedad intelectual">
          <p>
            Salvo que se indique lo contrario, la Plataforma, incluyendo diseño,
            marca, textos, organización, funcionalidades y materiales,
            pertenece a GOKAI o cuenta con licencias para su uso.
          </p>
          <p>
            El Usuario obtiene una licencia personal, limitada, no exclusiva, no
            transferible y revocable para usar la Plataforma únicamente para
            fines personales y conforme a estos Términos.
          </p>
        </LegalSection>

        <LegalSection title="9. Contenido del Usuario">
          <p>
            El Usuario conserva los derechos que correspondan sobre su Contenido
            del Usuario.
          </p>
          <p>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <LegalList
                items={[
                  <>
                    autorizas el procesamiento automatizado del audio con fines
                    de evaluación y retroalimentación;
                  </>,
                  <>
                    reconoces que los resultados son estimaciones y pueden
                    variar según ruido, micrófono, acento, velocidad del habla y
                    otros factores;
                  </>,
                  <>
        ...
        <LegalSection title="11. Privacidad y tratamiento de datos">
          <p>
            ...
            , la cual forma parte complementaria de estos Términos y describe el
            tratamiento de datos personales, audio y métricas de aprendizaje.
          </p>
          <p>
        ...
        <LegalSection title="12. Disponibilidad del servicio y cambios">
          <p>
            ...
            garantiza acceso ininterrumpido. Podrían presentarse interrupciones
            por mantenimiento, mejoras, incidencias o causas ajenas a nuestro
            control.
          </p>
          <p>
          ...
          <p>
            ...
            disponibles y utilizar la versión más reciente del software o de las
            aplicaciones compatibles cuando ello sea necesario para seguridad,
            estabilidad o acceso a funciones.
          </p>
        </LegalSection>

        <LegalSection title="13. Enlaces y servicios de terceros">
          <p>
            La Plataforma puede incluir enlaces o integraciones de terceros, por
            ejemplo procesadores de pago, redes sociales u otros. El uso de
            dichos servicios queda sujeto a los términos y políticas de esos
            terceros.
          </p>
          <p>
            GOKAI no es responsable por el contenido, disponibilidad o prácticas
            de terceros ajenos.
          </p>
        </LegalSection>
        ...
        <LegalSection title="15. Resultados de aprendizaje y exclusión de garantías">
          <p>
            Los resultados de aprendizaje dependen de la constancia del Usuario,
            su nivel previo, el tiempo de estudio, la calidad del repaso, la
            práctica fuera de la Plataforma y otros factores personales.
          </p>
          <p>
          ...
          <p>
            En la medida permitida por la ley, la Plataforma se proporciona “tal
            cual” y “según disponibilidad”, sin garantías de ningún tipo, ya
        ...
        <LegalSection title="16. Limitación de responsabilidad">
          ...
          <p>
            ...
            limitará al monto efectivamente pagado por el Usuario a GOKAI por la
            suscripción en el periodo inmediatamente anterior al hecho que dio
            origen al reclamo, o al mínimo permitido por ley.
          </p>
        </LegalSection>
        ...
        <LegalSection title="18. Modificaciones de estos Términos">
          <p>
            GOKAI puede actualizar estos Términos cuando sea necesario. La fecha
            de <strong>“Última actualización”</strong> indicará el momento del
            cambio.
          </p>
          <p>
