...
export function SettingsSidebar({
  ...
  return (
    <aside className="w-20 md:w-72 bg-surface-primary border-r border-border-default min-h-screen">
          ...
          {menuItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {selected === item.id && (
                  <span className="hidden md:inline ml-auto w-1.5 h-1.5 bg-accent rounded-full"></span>
                )}
              </button>
            );
          })}
