...
export function GrammarBoardBackdrop() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.92] bg-[radial-gradient(ellipse_44%_34%_at_18%_26%,rgba(212,168,67,0.055)_0%,transparent_64%),radial-gradient(ellipse_38%_30%_at_78%_62%,rgba(184,146,46,0.038)_0%,transparent_60%),radial-gradient(ellipse_56%_40%_at_52%_84%,rgba(212,168,67,0.03)_0%,transparent_68%)] dark:bg-[radial-gradient(ellipse_44%_34%_at_18%_26%,rgba(240,210,122,0.06)_0%,transparent_64%),radial-gradient(ellipse_38%_30%_at_78%_62%,rgba(184,146,46,0.04)_0%,transparent_60%),radial-gradient(ellipse_56%_40%_at_52%_84%,rgba(212,168,67,0.03)_0%,transparent_68%)]" />
      <div className="absolute inset-0 opacity-[0.9] bg-[radial-gradient(ellipse_58%_44%_at_50%_42%,rgba(212,168,67,0.065)_0%,rgba(155,123,47,0.022)_54%,transparent_78%),radial-gradient(ellipse_34%_26%_at_22%_22%,rgba(200,158,60,0.034)_0%,transparent_58%),radial-gradient(ellipse_30%_24%_at_76%_74%,rgba(184,146,46,0.028)_0%,transparent_56%)] dark:bg-[radial-gradient(ellipse_58%_44%_at_50%_42%,rgba(240,210,122,0.08)_0%,rgba(155,123,47,0.03)_54%,transparent_78%),radial-gradient(ellipse_34%_26%_at_22%_22%,rgba(212,168,67,0.04)_0%,transparent_58%),radial-gradient(ellipse_30%_24%_at_76%_74%,rgba(184,146,46,0.03)_0%,transparent_56%)]" />
