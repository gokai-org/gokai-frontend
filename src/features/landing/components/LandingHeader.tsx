      ...
      <div className="flex w-full items-center justify-between px-6 py-3 md:px-10 lg:px-14 2xl:px-20">
        <div className="flex items-center gap-4 md:gap-5">
          <a
            ...
            className="text-[2rem] font-black leading-none tracking-[0.12em] text-content-primary md:text-[2.35rem]"
          >
            GOKAI
          </a>
        ...
        <nav className="relative hidden items-center gap-2 rounded-full border border-black/[0.06] bg-surface-primary/80 p-1.5 shadow-[0_10px_30px_-18px_rgba(0,0,0,0.18)] backdrop-blur-xl md:flex">
          <LandingNavItem
            id="inicio"
            href="#inicio"
          ...
          <motion.a
            ...
            className="ml-2 inline-flex rounded-full bg-gradient-to-r from-[#b8423d] via-[#a73834] to-[#8d2d2a] px-5 py-3 text-sm font-bold text-content-inverted shadow-[0_14px_30px_-12px_rgba(153,51,49,0.36)]"
          >
            Iniciar sesión
          </motion.a>
        </nav>
        ...
        <a
          href="/auth/login"
          className="rounded-full bg-gradient-to-r from-accent to-accent-hover px-5 py-3 text-sm font-bold text-content-inverted shadow-lg shadow-accent/20 md:hidden"
        >
          Iniciar
        </a>
      </div>
