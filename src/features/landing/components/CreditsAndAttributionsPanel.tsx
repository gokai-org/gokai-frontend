...
export function CreditsAndAttributionsPanel({
  ...
  return (
    ...
    >
      <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain pr-1 touch-pan-y [-webkit-overflow-scrolling:touch] sm:pr-2 md:pr-3">
        ...
        <div className="mt-4 space-y-4 pb-5 sm:mt-5 sm:pb-6">
          <CreditsSection title="Recursos visuales">
            <p>
              GOKAI utiliza distintos recursos visuales, gráficos y multimedia
              con fines educativos, informativos y de experiencia de usuario
              dentro de la plataforma.
            </p>
            <p>
              Parte de los recursos utilizados fueron obtenidos de bibliotecas
              de contenido libre y plataformas de recursos gráficos, respetando
              sus respectivas licencias y condiciones de uso.
            </p>
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                ...
                plataforma provienen de Pixabay. Dichos contenidos son
                utilizados conforme a la Licencia de Contenido de Pixabay, la
                cual permite el uso y modificación de recursos libres de
                regalías para proyectos digitales y educativos.
              </p>
              <p>
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                Algunos vectores, ilustraciones e imágenes utilizados dentro de
                la interfaz y materiales visuales de GOKAI provienen de
                Vecteezy. Estos recursos son utilizados conforme a los términos
                y condiciones establecidos por la plataforma y sus respectivas
                licencias de uso.
              </p>
              <p>
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                Si algún autor o propietario considera necesaria una corrección
                de atribución o contenido, puede solicitarlo mediante los
                canales oficiales de contacto del proyecto.
              </p>
            </div>
          </CreditsSection>
          ...
          <CreditsSection title="Contenido y recursos lingüísticos">
            <p>
              ...
              apoyar la enseñanza y visualización del idioma japonés dentro de
              la plataforma.
            </p>
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                ...
                2009-2026 Ulrich Apel), obtenidos desde su repositorio oficial
                en GitHub. Estos recursos son utilizados para la representación
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                ...
                pueden haber sido adaptados o integrados visualmente para
                mejorar la experiencia educativa de la plataforma, respetando
                siempre las condiciones de atribución y compartición
                establecidas por la licencia original.
              </p>
            </div>
          </CreditsSection>
          ...
          <CreditsSection title="Inteligencia Artificial, bibliografía técnica y datasets">
            <p>
              ...
              análisis acústico y sistemas de recomendación con fines
              educativos, experimentales y de investigación aplicada dentro de
              la plataforma.
            </p>
            <p>
              ...
              especializados en representación semántica de lenguaje, análisis
              de voz, embeddings, aprendizaje por refuerzo y reconocimiento
              acústico.
            </p>

            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              <h4 className="text-sm font-semibold text-content-primary md:text-base">
                Parte de las funcionalidades implementadas dentro de la
                plataforma incluyen
              </h4>
              <ul className="list-disc space-y-1.5 pl-5">
                <li>Sistemas de recomendación de contenidos personalizados.</li>
                <li>
                  Representación semántica mediante embeddings vectoriales.
                </li>
                <li>
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                ...
                investigaciones académicas y herramientas open-source
                reconocidas dentro del ámbito de Inteligencia Artificial y
                Machine Learning.
              </p>
            </div>
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                ...
                contextual de texto utilizado en GOKAI se basa en
                investigaciones relacionadas con Sentence-BERT desarrolladas por
                Nils Reimers e Iryna Gurevych.
              </p>
              <p>
                Estas investigaciones sirvieron como referencia conceptual para
                la representación vectorial de contenido educativo y
                recomendaciones inteligentes dentro de la plataforma.
              </p>
              <div>
                <p>
                ...
                <ul className="mt-2 list-disc space-y-2 pl-5">
                  ...
                  <li>
                    Reimers, N., Gurevych, I. (2020). “Making Monolingual
                    Sentence Embeddings Multilingual using Knowledge
                    Distillation.” Proceedings of EMNLP 2020.{" "}
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                ...
                Librosa para procesamiento de voz y extracción de
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                ...
                componentes de Inteligencia Artificial implementados en GOKAI
                fue apoyado por investigaciones académicas relacionadas con:
              </p>
              <ul className="list-disc space-y-1.5 pl-5">
              ...
              <p>
                Entre las referencias consultadas se encuentran investigaciones
                y publicaciones de instituciones como:
              </p>
              <ul className="list-disc space-y-1.5 pl-5">
              ...
              <p>
                Estas investigaciones fueron utilizadas exclusivamente como
                apoyo académico, referencia metodológica y fundamento conceptual
                para el desarrollo experimental de los módulos de Inteligencia
                Artificial implementados en GOKAI.
              </p>
            </div>
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                Parte de los modelos de Inteligencia Artificial utilizados
                dentro de GOKAI fueron entrenados utilizando extractos del
                conjunto de datos público “FLEURS — Few-shot Learning Evaluation
              ...
              <p>
                ...
                Dalmia, S., Riesa, J., Rivera, C., Bapna, A. (2022). “FLEURS:
                Few-shot Learning Evaluation of Universal Representations of
                Speech.” IEEE Spoken Language Technology Workshop (SLT).{" "}
            ...
            <div className="space-y-3 rounded-xl border border-border-default/70 bg-surface-primary/60 p-4">
              ...
              <p>
                Todas las tecnologías, investigaciones, bibliotecas y conjuntos
                de datos mencionados pertenecen a sus respectivos autores,
              ...
              <p>
                ...
                académicos, experimentales y de desarrollo tecnológico dentro
                del contexto del proyecto GOKAI, respetando las licencias
