...
export function MiniGokaDock() {
  ...
  const deltaToneClassName =
    (delta?.value ?? 0) >= 0
      ? "border-emerald-300/60 bg-emerald-500/18 text-emerald-700 dark:border-emerald-300/25 dark:bg-emerald-400/18 dark:text-emerald-100"
      : "border-rose-300/60 bg-rose-500/18 text-rose-700 dark:border-rose-300/25 dark:bg-rose-400/18 dark:text-rose-100";
  ...
  return (
    <motion.aside
      ...
      aria-live="polite"
    >
      <div className="relative flex min-h-[32px] min-w-[84px] items-center justify-center rounded-full border border-border-subtle bg-surface-elevated/95 pl-7 pr-2.5 shadow-[0_10px_22px_rgba(15,23,42,0.1),0_3px_8px_rgba(148,163,184,0.1)] backdrop-blur-sm dark:border-white/10 dark:bg-[#18161d]/94 dark:shadow-[0_12px_30px_rgba(0,0,0,0.34),0_2px_12px_rgba(15,23,42,0.16)] md:min-h-[34px] md:min-w-[92px] md:pl-7.5 md:pr-3 lg:min-h-[38px] lg:min-w-[102px] lg:pl-8 lg:pr-3.5">
        <div className="absolute left-0 top-1/2 flex h-7.5 w-7.5 -translate-x-[12%] -translate-y-1/2 items-center justify-center rounded-full bg-gradient-to-br from-accent-hover to-accent shadow-[0_9px_18px_rgba(153,51,49,0.22)] ring-2 ring-white dark:ring-[#18161d] md:h-8 md:w-8 lg:h-9 lg:w-9">
          <div className="absolute inset-[4px] rounded-full border border-white/65 dark:border-white/25" />
        ...
        <div className="relative flex w-full justify-center pl-2 leading-none text-center text-content-primary">
          <motion.span
            ...
            className="block min-w-[40px] text-center text-[14px] font-black tabular-nums tracking-[-0.03em] text-content-primary md:min-w-[44px] md:text-[15px] lg:min-w-[48px] lg:text-[17px]"
          >
