  ...
  return (
    <section className="rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          <h3 className="text-base font-bold text-gray-900">Todos los cupones</h3>
        ...
        <table className="min-w-[780px] md:min-w-[880px] xl:min-w-0 w-full table-fixed bg-white">
          <thead className="bg-[#F8F6F4] text-left">
            <tr>
              ...
              <th className="px-2.5 py-2.5 text-[11px] font-semibold tracking-wide text-gray-500 sm:px-3 lg:px-4">Codigo</th>
              <th className="px-2.5 py-2.5 text-[11px] font-semibold tracking-wide text-gray-500 sm:px-3 lg:px-4">Descripcion</th>
              <th className="px-2.5 py-2.5 text-[11px] font-semibold tracking-wide text-gray-500 sm:px-3 lg:px-4">Meses</th>
              <th className="px-2.5 py-2.5 text-[11px] font-semibold tracking-wide text-gray-500 sm:px-3 lg:px-4">Limite de canjes</th>
              <th className="px-2.5 py-2.5 text-[11px] font-semibold tracking-wide text-gray-500 sm:px-3 lg:px-4">Vigencia</th>
