...
export function RecentCard({ item, onClick }: RecentCardProps) {
  return (
    <div
      onClick={onClick}
      className="group flex gap-3 p-3 bg-white rounded-xl border border-gray-200 hover:border-[#993331] hover:shadow-md transition-all duration-300 cursor-pointer h-full"
    >
